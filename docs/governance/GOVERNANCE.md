...
|---:|---|---|---|---|
| 1 | Governance and safety foundation | approved plan, user approval | verifier passing, baseline frozen, dev/main sync, explicit confirmation | in-progress |
| 2 | Product discovery and PRD | Phase 1 complete, approved PRP | approved PRD in `.claude/PRPs/prds/`, explicit confirmation | pending |
...
| 7 | Performance, motion & UX | Phase 6 complete, approved PRP | 60fps rendering, Compose metrics, haptics, transition polish | pending |
